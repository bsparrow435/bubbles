...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING("HaxeFlixel"),HX_CSTRING("bubbles"),HX_CSTRING("com.example.myapp"),HX_CSTRING("0.0.1"));
